...
- **Uber's SubmitQueue / BLRD.** Speculation engine with probabilistic models and a target-hash conflict analyzer. After enabling BLRD in mid-2023, Uber reported a 74% reduction in P95 wait time. Heavyweight and inspirational; not what I'd build first.
